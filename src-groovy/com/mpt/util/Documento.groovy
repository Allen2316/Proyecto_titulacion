...
class Documento {
		...
		try {
			...
			if (idTipoDocumento == CertificateFields.INFORME_PERTINENCIA_ID_2) {
				...
				replacementsList.add([
					...
					|| idTipoDocumento == CertificateFields.INFORME_SUSTENTACION_ID_7) {
	 ...
	 * @return La equivalencia de la nota según el promedio.
	 */
